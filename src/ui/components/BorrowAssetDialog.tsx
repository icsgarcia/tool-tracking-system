...
const BorrowAssetDialog = ({
    ...
    useEffect(() => {
        ...
        const scannerId = "borrow-camera-qr-reader";
        let mounted = true;
        ...
        borrowAsset.mutate(
            { userId: user.id, assetQrCode: code!, borrowCount },
            {
                ...
                onError: (error) => {
                    toast.error(
                        error.message ||
                            "Borrowing Tool failed. Please try again.",
                    );
                    isProcessing.current = false;
                },
            },
    ...
    return (
        <Dialog open={openBorrowDialog} onOpenChange={handleCloseDialog}>
